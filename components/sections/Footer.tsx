    ...
    <footer className="relative overflow-hidden border-t border-[var(--mm-border)] bg-black">
      <Container>
        ...
        <div className="relative py-24 md:py-32 lg:py-40">
          ...
          >
            <h2 className="max-w-[1500px] font-[var(--font-inter-tight)] text-[clamp(4rem,12vw,13rem)] font-extrabold uppercase leading-[0.76] tracking-[-0.08em]">
              Let&apos;s
              <br />
              talk
        ...
        <div className="grid border-t border-[var(--mm-border)] md:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr]">
          {/* Brand */}
          <div className="border-b border-[var(--mm-border)] py-10 md:border-r md:pr-10 lg:border-b-0">
          ...
          {/* Navigation */}
          <div className="border-b border-[var(--mm-border)] py-10 md:pl-10 lg:border-b-0 lg:border-r lg:pr-10">
          ...
          {/* Contact */}
          <div className="py-10 md:col-span-2 lg:col-span-1 lg:pl-10">
            <p className="mm-mono mb-6 text-xs text-white/30">
              Contact
            </p>
        ...
        {/* Bottom bar */}
        <div className="flex flex-col gap-4 border-t border-[var(--mm-border)] py-6 sm:flex-row sm:items-center sm:justify-between">
