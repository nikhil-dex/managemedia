...
export default function Services() {
      ...
      <Container>
        ...
        <div className="mb-20 flex flex-col gap-8 md:mb-28 md:flex-row md:items-start md:justify-between">
          ...
          <div className="max-w-2xl">
            ...
            className="font-[var(--font-inter-tight)] text-[clamp(3.5rem,8vw,8rem)] font-extrabold uppercase leading-[0.82] tracking-[-0.07em]">
              What
              <br />
              we do.
            </h2>
          ...
          <p
          data-services-intro
           className="max-w-xs text-sm leading-relaxed text-white/45 md:pt-3">
  ...
  />
        ...
        <div className="mt-20 flex justify-end md:mt-28">
          <p
          data-services-closing
          className="max-w-xl font-[var(--font-inter-tight)] text-2xl font-medium leading-tight tracking-[-0.03em] text-white/65 md:text-4xl">
